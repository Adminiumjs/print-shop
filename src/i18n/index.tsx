 ...
 *
 * Money carries two decimals throughout. A print works quotes unit prices in
 * fractions of a cent — "$0.19 each" is the number a customer decides on — so
 * rounding to whole currency anywhere would make the quote panel lie.
 */
import {
  createContext,
  useCallback,
...
const STORAGE_KEY = "print-shop-locale";
